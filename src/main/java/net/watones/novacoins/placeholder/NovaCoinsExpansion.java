package net.watones.novacoins.placeholder;

import me.clip.placeholderapi.expansion.PlaceholderExpansion;
import net.watones.novacoins.config.ConfigManager;
import net.watones.novacoins.economy.WalletService;
import net.watones.novacoins.session.*;
import net.watones.novacoins.util.Formatters;
import org.bukkit.OfflinePlayer;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

public final class NovaCoinsExpansion extends PlaceholderExpansion {
  private final WalletService wallets;
  private final SessionRegistry sessions;
  private final ConfigManager config;

  public NovaCoinsExpansion(WalletService wallets, SessionRegistry sessions, ConfigManager config) {
