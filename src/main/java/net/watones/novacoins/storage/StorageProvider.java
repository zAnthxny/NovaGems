...
public interface StorageProvider extends AutoCloseable {
  ...
  Optional<CoinTransaction> findTransaction(UUID operationId) throws Exception;

  List<LeaderboardEntry> leaderboard(int offset, int limit) throws Exception;

  List<CoinTransaction> history(UUID uuid, int offset, int limit) throws Exception;

  List<CoinTransaction> deliveryFailures(int offset, int limit) throws Exception;
